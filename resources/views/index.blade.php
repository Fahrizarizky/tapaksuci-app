...
<html lang="en">
    ...
    <body id="page-top">
            ...
            <div class="container px-4 px-lg-5 h-100">
                <div class="row gx-4 gx-lg-5 h-100 align-items-center justify-content-center text-center">
                    <div class="col-lg-8 align-self-end">
                        <h1 class="text-white font-weight-bold">Tapak Suci Pekanbaru</h1>
                        <hr class="divider" />
                    </div>
        ...
        <footer class="bg-light py-5">
            <div class="container px-4 px-lg-5"><div class="small text-center text-muted">Copyright &copy; 2024 - Tapak Suci</div></div>
        </footer>
        <!-- Bootstrap core JS-->
