        ...
        <table class="table table-striped table-sm">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>{{ $item->tanggal }}</td>
              <td><button class="btn btn-sm btn-primary" data-bs-toggle="modal" data-bs-target="#imageModal">Lihat Ijazah</button></td>
              <td>
            ...
            <div class="modal-content">
              ...
              <div class="modal-body d-flex justify-content-center">
                <!-- Menampilkan gambar di dalam modal -->
                  @if(isset($item->ijazah))
                <img src="{{ asset('storage/'.optional($item)->ijazah) }}" class="img-fluid align-center" alt="Gambar">
                @endif
              </div>
            </div>
          </div>
