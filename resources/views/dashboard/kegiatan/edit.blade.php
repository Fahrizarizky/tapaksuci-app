...
<div class="container-fluid">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4 col-md-9">
        <h1 class="h3 text-dark text-uppercase fw-bold">Edit Kegiatan</h1>
    ...
    <div class="card shadow mb-4 col-md-9">
        <div class="card-body">
            <form action="/dashboard/kegiatan/update/{{ $kegiatan->id }}" method="POST">
                @csrf
                ...
                <div class="form-group">
                    ...
                    <input type="date" class="form-control" id="waktu" name="waktu" value="{{ $kegiatan->waktu }}" required>
                </div>
                <div class="form-group">
                    <label for="lokasi" class="font-weight-bold">Lokasi Pelaksanaan</label>
                    <input type="text" class="form-control" id="lokasi" name="lokasi" value="{{ $kegiatan->lokasi }}" required>
                </div>
                <div class="form-group">
                    ...
                    <select type="text" class="form-control" id="ketua_panitia" name="ketua_panitia" required>
                        ...
                        <option {{$anggota->nama === $ketua_panitia ? 'selected' : ''}}>{{$anggota->nama}}</option>
                        @endforeach
                    </select>
                </div>
                <div class="form-group">
                    ...
                    <select type="text" class="form-control" id="wakilketua_panitia" name="wakilketua_panitia" required>
                        @foreach($anggotapimda as $anggota)
                        <option {{$anggota->nama === $wakilketua_panitia ? 'selected' : ''}}>{{$anggota->nama}}</option>
                        @endforeach
                    </select>
                </div>
                <div class="form-group">
                    ...
                    <select type="text" class="form-control" id="sekretaris_panitia" name="sekretaris_panitia" required>
                        @foreach($anggotapimda as $anggota)
                        <option {{$anggota->nama === $sekretaris_panitia ? 'selected' : ''}}>{{$anggota->nama}}</option>
                        @endforeach
                    </select>
                </div>
                <div class="form-group">
                    ...
                    <select type="text" class="form-control" id="bendahara_panitia" name="bendahara_panitia" required>
                        @foreach($anggotapimda as $anggota)
                        <option {{$anggota->nama === $bendahara_panitia ? 'selected' : ''}}>{{$anggota->nama}}</option>
                        @endforeach
                    </select>
                </div>
                <div class="form-group">
                    ...
                    <select type="text" class="form-control" id="jenis" name="jenis" required>
                        ...
                        <option {{$kegiatan->nama === $jenis ? 'selected' : ''}}>{{$kegiatan->nama}}</option>
                        @endforeach
                    </select>
                </div>
