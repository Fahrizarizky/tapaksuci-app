...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4 col-md-9">
        <div class="card-body">
            <form action="/dashboard/suratkeluar/update/{{$suratkeluar->id}}" method="POST">
                @csrf
                <div class="form-group">
                    <label for="kode_surat" class="font-weight-bold">Kode Surat</label>
                    <input type="text" class="form-control" id="kode_surat" name="kode_surat" value="{{$suratkeluar->kode_surat}}" readonly required>
                </div>
                <div class="form-group">
                    <label for="judul_surat" class="font-weight-bold">Judul Surat</label>
                    <input type="text" class="form-control" id="judul_surat" name="judul_surat" value="{{$suratkeluar->judul_surat}}" required>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="hal_surat" name="hal_surat" value="{{$suratkeluar->hal_surat}}" required>
                </div>
                <div class="form-group">
                    <label for="tujuan_surat" class="font-weight-bold">Tujuan Surat</label>
                    <input type="text" class="form-control" id="tujuan_surat" name="tujuan_surat" value="{{$suratkeluar->tujuan_surat}}" required>
                </div>
                <div class="form-group">
                    <label for="isi_surat" class="font-weight-bold">Isi Surat</label>
                    <textarea name="isi_surat" rows="5" class="form-control" value="{{$suratkeluar->isi_surat}}" required></textarea>
                </div>
