...
<div class="container-fluid">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4 col-md-9">
        <h1 class="h3 text-dark text-uppercase fw-bold">Edit Pengeluaran</h1>
    ...
    <div class="card shadow mb-4 col-md-9">
        <div class="card-body">
            <form action="/dashboard/pengeluaran/update/{{$pengeluaran->id}}" method="POST">
                @csrf
                <div class="form-group">
                    <label for="kode_transaksi" class="font-weight-bold">Kode Transaksi</label>
                    <input type="text" class="form-control" id="kode_transaksi" name="kode_transaksi" value="{{$pengeluaran->kode_transaksi}}" required>
                </div>
                <div class="form-group">
                    <label for="tahun_buku" class="font-weight-bold">Tahun Buku</label>
                    <input type="text" class="form-control" id="tahun_buku" name="tahun_buku" value="{{$pengeluaran->tahun_buku}}" required>
                </div>
                <div class="form-group">
                    <label for="nama_transaksi" class="font-weight-bold">Nama Transaksi</label>
                    <input type="text" class="form-control" id="nama_transaksi" name="nama_transaksi" value="{{$pengeluaran->nama_transaksi}}" required>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="peminta" name="peminta" value="{{$pengeluaran->peminta}}" required>
                </div>
                <div class="form-group">
                    <label for="pemberi" class="font-weight-bold">Dikeluarkan Oleh</label>
                    <input type="text" class="form-control" id="pemberi" name="pemberi" value="{{$pengeluaran->pemberi}}" required>
                </div>
                <div class="form-group">
                    <label for="tanggal_penyerahan" class="font-weight-bold">Tanggal Penyerahan</label>
                    <input type="date" class="form-control" id="tanggal_penyerahan" name="tanggal_penyerahan" value="{{$pengeluaran->tanggal_penyerahan}}" required>
                </div>
                <div class="form-group">
                    <label for="lokasi_penyerahan" class="font-weight-bold">Lokasi Penyerahan</label>
                    <input type="text" class="form-control" id="lokasi_penyerahan" name="lokasi_penyerahan" value="{{$pengeluaran->lokasi_penyerahan}}" required>
                </div>
                <div class="form-group">
